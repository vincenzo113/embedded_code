...
int8_t button_reset_pressed(button_t *button , button_state_t *state){
	
}


//Viene chiamata nella callback del pulsante: arriva l'interrupt , la callback dell'interruzione chiama questa funzione  
int8_t button_pressed_handler(button_t *button , button_state_t *state){
