...
/* correzioni rispetto alla versione originale disponibile su GitHub:
- maschere setAlarm per minuti e secondi 
- registri per DS3231_SetAlarm2Mode
- maschera DS3231_Enable32kHzOutput */
